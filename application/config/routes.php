...
$route['^(?!shop|blog|login|register|user|logout|reset-password|dashboard|contact|admin|pages|category|categories|tag|author|api|assets|static)(.+)$'] = 'pages/render_by_path/$1';
